...
int lua_cocos2dx_TMXMapInfo_getRenderOrder(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::TMXMapInfo* cobj = nullptr;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_TMXMapInfo_getRenderOrder'", nullptr);
        return 0;
    }
#endif
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.TMXMapInfo:getRenderOrder",argc, 0);
    return 0;
    
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_TMXMapInfo_getRenderOrder'.",&tolua_err);
    return 0;
#endif
}
...
int lua_register_cocos2dx_TMXMapInfo(lua_State* tolua_S)
{
    ...
    tolua_function(tolua_S,"getRenderOrder",lua_cocos2dx_TMXMapInfo_getRenderOrder);
